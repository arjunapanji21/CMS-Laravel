...
<body>
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
        ...
        >
          <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
            ...
            <ul class="space-y-2">
              ...
              <li>
                <button
                  type="button"
                  class="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 @if($pageTitle == 'Posts') bg-primary-600 text-white @endif"
          ...
          >
            <span class="italic text-gray-400">v1.0.1</span>
          </div>
        </aside>

...
<footer class="bg-primary-600 text-gray-100">
    <div class="mx-auto w-full max-w-screen-xl">
      <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        <div>
            <h2 class="mb-6 text-sm font-semibold text-gray-300 uppercase dark:text-white">Company</h2>
            <ul class="text-gray-100 dark:text-gray-100 font-medium">
                <li class="mb-4">
        ...
        <div>
            <h2 class="mb-6 text-sm font-semibold text-gray-300 uppercase dark:text-white">Help center</h2>
            <ul class="text-gray-100 dark:text-gray-100 font-medium">
                <li class="mb-4">
        ...
        <div>
            <h2 class="mb-6 text-sm font-semibold text-gray-300 uppercase dark:text-white">Download</h2>
            <ul class="text-gray-100 dark:text-gray-100 font-medium">
                <li class="mb-4">
    ...
    <div class="px-4 py-6 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-100 dark:text-white sm:text-center">© 2023 <a href="https://flowbite.com/">Flowbite™</a>. All Rights Reserved.
        </span>
        <div class="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
            <a href="#" class="text-gray-100 hover:text-white dark:hover:text-white">
...
<div class="fixed end-6 bottom-24 group">
    <a href="#" aria-expanded="false" class="flex items-center justify-center text-white bg-primary-700 rounded-full w-14 h-14 hover:bg-primary-800 dark:bg-primary-600 dark:hover:bg-primary-700 focus:ring-4 focus:ring-primary-300 focus:outline-none dark:focus:ring-primary-800">

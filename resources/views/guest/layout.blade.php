...
<body>
<div id="banner" tabindex="-1" class="flex sticky top-0 z-50 gap-8 justify-between items-start py-3 px-4 w-full bg-primary-50 border border-b border-primary-200 sm:items-center dark:border-primary-700 lg:py-4 dark:bg-primary-800">
    <div class="mx-auto">
        <p class="text-sm text-gray-500 dark:text-white">Tingkatkan Visibilitas Bisnis dan Brand Awareness Anda dengan <a class="font-medium underline text-primary-600 dark:text-primary-400 hover:no-underline animate-pulse" href="#">Website Profesional Kami!</a></p>
    </div>
...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
        <a href="{{route('guest.home')}}" class="flex items-center space-x-3 rtl:space-x-reverse">
            {{-- <img src="#" class="h-8" alt="Website Logo" /> --}}
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">CMS Laravel</span>
        </a>
        <div class="flex items-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse">
            <a href="{{route('guest.login')}}" class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Login</a>
            <a href="{{route('guest.register')}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Sign up</a>
        ...
        <div id="mega-menu-icons" class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
            <ul class="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
                <li>
                    <a href="{{route('guest.home')}}" class="block py-2 px-3 text-blue-600 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-blue-500 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">Home</a>
                </li>
                <li>
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                    ...
                    <div id="mega-menu-icons-dropdown" class="absolute z-10 grid hidden w-auto grid-cols-2 text-sm bg-white border border-gray-100 rounded-lg shadow-md dark:border-gray-700 md:grid-cols-3 dark:bg-gray-700">
                        <div class="p-4 pb-0 text-gray-900 md:pb-4 dark:text-white">
                            <ul class="space-y-4" aria-labelledby="mega-menu-icons-dropdown-button">
                                <li>
                                    <a href="#" class="flex items-center text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-500 group">
                ...
                <li>
                    <a href="#" class="block py-2 px-3 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Testimonies</a>
                </li>
                <li>
                    <a href="#" class="block py-2 px-3 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Blog</a>
                </li>
            </ul>
        </div>
    </div>
...
<footer class="bg-primary-600 dark:bg-primary-900 antialiased">
    <div class="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
        <div class="grid grid-cols-2 gap-8 lg:grid-cols-4">
            <div>
                <h2 class="mb-6 text-sm font-semibold text-gray-200 uppercase dark:text-gray-100">Company</h2>
                <ul class="text-gray-100 dark:text-white">
                    <li class="mb-4">
            ...
            <div>
                <h2 class="mb-6 text-sm font-semibold text-gray-200 uppercase dark:text-gray-100">Help center</h2>
                <ul class="text-gray-100 dark:text-white">
                    <li class="mb-4">
            ...
            <div>
                <h2 class="mb-6 text-sm font-semibold text-gray-200 uppercase dark:text-gray-100">Legal</h2>
                <ul class="text-gray-100 dark:text-white">
                    <li class="mb-4">
            ...
            <div>
                <h2 class="mb-6 text-sm font-semibold text-gray-200 uppercase dark:text-gray-100">Download</h2>
                <ul class="text-gray-100 dark:text-white">
                    <li class="mb-4">
        ...
        <div class="text-center">
            ...
            <ul class="flex justify-center mt-5 space-x-5">
                <li>
                    <a href="#" class="text-gray-100 hover:text-gray-300 dark:hover:text-white dark:text-gray-200">
...
<div class="fixed end-7 bottom-24 group">
    <a href="#" aria-expanded="false" class="flex opacity-25 hover:opacity-100 items-center justify-center text-white bg-primary-700 rounded-full w-11 h-11 hover:bg-primary-800 dark:bg-primary-600 dark:hover:bg-primary-700 focus:ring-4 focus:ring-primary-300 focus:outline-none dark:focus:ring-primary-800">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-8 h-8" fill="currentColor"><path d="M201.4 137.4c12.5-12.5 32.8-12.5 45.3 0l160 160c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L224 205.3 86.6 342.6c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3l160-160z"/></svg>
        <span class="sr-only">Open actions menu</span>
    </a>
</div>
<div class="fixed end-6 bottom-6 group">
    <a href="https://wa.me/6281271310334" target="_blank" aria-expanded="false" class="flex items-center justify-center text-white bg-green-700 rounded-full w-14 h-14 hover:bg-green-800 dark:bg-green-600 dark:hover:bg-green-700 focus:ring-4 focus:ring-green-300 focus:outline-none dark:focus:ring-green-800">

@extends(config('app.theme').'.guest.layout')
...
<section class="bg-primary-600 dark:bg-primary-900">
    <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
        <dl class="grid max-w-screen-md gap-8 mx-auto text-gray-100 sm:grid-cols-3 dark:text-white">
            <div class="flex flex-col items-center justify-center">
                <dt class="mb-2 text-3xl md:text-4xl font-extrabold">73M+</dt>
                <dd class="font-light text-gray-300 dark:text-gray-300">developers</dd>
            </div>
            <div class="flex flex-col items-center justify-center">
                <dt class="mb-2 text-3xl md:text-4xl font-extrabold">1B+</dt>
                <dd class="font-light text-gray-300 dark:text-gray-300">contributors</dd>
            </div>
            <div class="flex flex-col items-center justify-center">
                <dt class="mb-2 text-3xl md:text-4xl font-extrabold">4M+</dt>
                <dd class="font-light text-gray-300 dark:text-gray-300">organizations</dd>
            </div>
        </dl>
    </div>
  </section>
...
<section class="bg-white dark:bg-gray-900">
  ...
  <section class="bg-primary-600 dark:bg-primary-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="max-w-screen-lg text-gray-100 sm:text-lg dark:text-white">
            <h2 class="mb-4 text-4xl tracking-tight font-bold text-gray-100 dark:text-white">Powering innovation at <span class="font-extrabold">200,000+</span> companies worldwide</h2>
            ...
            <a href="#" class="inline-flex items-center font-medium text-gray-300 hover:text-white dark:text-gray-100 dark:hover:text-white">
                Learn more
  ...
  <section class="bg-primary-600 dark:bg-primary-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-100 dark:text-white">Designed for business teams like yours</h2>
            <p class="mb-5 font-light text-gray-300 sm:text-xl dark:text-gray-200">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
        </div>
